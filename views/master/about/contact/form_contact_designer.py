...
class FormContactDesigner():
    def __init__(self, main_body, settings_panel, id):
        ...
        self.frameForm = LabelFrame(main_body, text='Contact Form', font=('Roboto', 15), bg='#f1faff')
    ...
    def submit_pqrs(self):
        ...
        messagebox.showinfo("PQRS Submitted", f"Thank you, {name}! Your Message has been submitted.")
        self.clear_form()
